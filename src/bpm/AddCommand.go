...
func NewAddCommand() *cobra.Command {
    ...
    flags.StringVar(&myCmd.Name, "name", "", "Use the specified name for the component instead of the name from the .git url. Ex: bpm add https://www.github.com/sample/js-sample.git --name sample")
